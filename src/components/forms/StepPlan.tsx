...
import { planStyle, getPlanCardColors } from '../features/new-ad/constants/config';
...
function PlanCard({
  ...
  return (
    ...
    >
      ...
      {showPopular && (
        <View style={[pc.badge, { backgroundColor: planCardColors.popularBadge }]}>
      ...
      <View style={pc.inner}>
        ...
        <View style={[pc.btn, { backgroundColor: selected ? ps.color : planCardColors.unselectedBtn }]}>
      ...
      <View style={[s.footer, { bottom: clearance }]}>
        ...
        {selected ? (
          <TouchableOpacity style={s.continueBtn} onPress={onNext} activeOpacity={0.88}>
            <MaterialCommunityIcons name="lock-outline" size={14} color={Colors.white} />
