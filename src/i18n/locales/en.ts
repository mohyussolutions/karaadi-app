...
export const mine = {
  ...
  identification: {
    gateTitle: "Verify your identity to continue",
    gateSub: "Karaadi now requires identity verification. Submit your ID card and a selfie to keep using the app.",
    retakePhoto: "Retake",
    usePhoto: "Use Photo",
    optionalTag: "(optional)",
    guestTitle: "Sign in to verify your identity",
    guestSub: "Log in to submit your ID card and a selfie for verification.",
    statusRequired: "Verification required",
    statusRequiredSub: "Your account needs identity verification. Submit your ID card and a selfie to continue.",
    statusOptional: "Identity verification",
    statusOptionalSub: "Verifying your identity adds a trust badge to your profile. This is optional for now.",
    statusSubmitted: "Verification submitted",
    statusSubmittedSub: "We've received your ID card and selfie. You can resubmit if you'd like to update them.",
    resubmit: "Resubmit with new photos",
    idCardLabel: "ID card photo",
    idCardHint: "Take a clear photo of the front of your national ID or passport.",
    selfieLabel: "Selfie",
    selfieHint: "Take a clear photo of your face for a face-match check against your ID.",
    retake: "Retake",
    submit: "Submit for verification",
    submittedTitle: "Submitted",
    submittedSub: "Your identity verification has been submitted successfully.",
  ...
  editProfile: {
    ...
    usernameInvalid: "Username must be 3-30 characters: letters, numbers, underscore and period only.",
    usernameUpdated: "Username updated.",
    usernameUpdateFailed: "Failed to update username.",
    saveUsername: "Save Username",
    phoneNumberLabel: "Phone Number",
    phoneEmpty: "Phone cannot be empty.",
    phoneInvalid: "Enter a valid Somali phone number.",
  ...
  settingsPage: {
    ...
    privacy: "Privacy",
    hidePhoneNumber: "Hide my phone number from my listings",
    hidePhoneOn: "Your phone number is hidden on your listings",
    hidePhoneOff: "Your phone number is visible on your listings",
    hidePhoneUpdateFailed: "Could not update phone number visibility. Please try again.",
  ...
  businesses: {
    ...
    nameTooLong: "Must be 150 characters or fewer",
    emailRequired: "Email is required",
    emailInvalid: "Enter a valid email address",
    phoneRequired: "Phone number is required",
    phoneInvalid: "Enter a valid Somali phone number",
    websiteInvalid: "Enter a valid website (e.g. example.com)",
    addressTooLong: "Must be 200 characters or fewer",
    descriptionTooLong: "Must be 2000 characters or fewer",
    contactNameTooLong: "Must be 100 characters or fewer",
    ...
    approvedMessage: "Your business has been approved. Continue to the next step.",
    ...
    prePlanTitle: "Choose Your Plan",
    prePlanDesc: "Step 1 of your business application.",
    continueToApply: "Continue with",
    tierBasic: "Basic",
    ...
    selectCategoriesTitle: "Choose Your Categories",
    selectCategoriesDesc: "Pick every category you plan to list under. You'll only be able to post listings in the categories selected here.",
...
export const postAd = {
  ...
  invalidWebsite: "Enter a valid website (e.g. example.com)",
  fieldTooLong: "{{label}} is too long",
  titleTooShort: "Title must be at least 2 characters",
  descriptionTooShort: "Description must be at least 5 characters",
  ...
  leaveCheckoutBody: "Your ad is saved but not live yet. You can finish payment anytime from My Ads.",
  leaveCheckoutConfirm: "Go to My Ads",
  ...
  activationPendingNote: "Payment received. Your listing is still being activated — if it doesn't appear in My Ads within a few minutes, please contact support.",
  viewListing: "View My Listing",
  viewMyAds: "View My Ads",
  socialShareTitle: "Share your listing on",
  socialSharingTo: "Sharing to",
  socialPostToFacebook: "Post to Facebook",
...
export const subscription = {
  ...
  priceRangeInvalid: "Minimum price must be less than or equal to maximum price.",
  selectCategory: "Select category",
  selectRegion: "Select region",
...
export const supportModule = {
  ...
  form: {
    ...
    subjectTooLong: "Subject must be 150 characters or fewer.",
    bodyTooLong: "Message must be 3000 characters or fewer.",
  },
} as const;
...
export const report = {
  ...
  errorDetailsTooLong: "Details must be 1000 characters or fewer",
