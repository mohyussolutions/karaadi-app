...
import SocialPostCard from '../../../../../../../components/cards/SocialPostCard/SocialPostCard';
...
export function SuccessScreen({ plan, listingTitle, listingId, categoryKey, createdItem, onDone, isPremium90 }: SuccessScreenProps) {
  const Colors = useThemeColors();
  const s = useThemedStyles(createStyles);
  const { t } = useAppTranslation();
  const listingUrl = getListingShareUrl(listingId, categoryKey || createdItem?.mainCategory);
