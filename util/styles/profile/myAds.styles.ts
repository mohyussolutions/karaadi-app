...
export function createStyles(Colors: ColorPalette) {
  return StyleSheet.create({
    ...
    headerSub: { fontSize: 13, color: Colors.textMuted, marginTop: 2, fontWeight: '600' },
    ...
    tierPillText: { fontSize: 10, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 0.3 },
    ...
    guestIconCircle: {
      ...
      backgroundColor: Colors.gray100, alignItems: 'center', justifyContent: 'center', marginBottom: 4,
    },
    guestTitle: { fontSize: 20, fontWeight: '700', color: Colors.textPrimary, textAlign: 'center' },
    ...
    postBtn: {
      ...
      margin: 16, backgroundColor: Colors.primary, borderRadius: 14, paddingVertical: 15,
