  ...
  return (
    <View style={s.header}>
      <View style={s.headerIconWrap}>
        <MaterialCommunityIcons name="receipt-text-outline" size={16} color={Colors.white} />
      </View>
      <View>
        <Text style={s.headerTitle}>{t('postAd.orderSummary', { defaultValue: 'Order Summary' })}</Text>
        <Text style={s.headerSub}>{t('postAd.reviewBeforePay', { defaultValue: 'Review your listing before paying' })}</Text>
      </View>
    </View>
  );
});
